...
namespace SKF.Enlight.API.Config {
  public static partial class ResourceConfig
  {
    ...
    {
      serviceBinder.AddMethod(__Method_GetSpecification, serviceImpl.GetSpecification);
      serviceBinder.AddMethod(__Method_GetConfig, serviceImpl.GetConfig);
      serviceBinder.AddMethod(__Method_GetLatestConfigByTargetID, serviceImpl.GetLatestConfigByTargetID);
      serviceBinder.AddMethod(__Method_GetAllLatestConfigs, serviceImpl.GetAllLatestConfigs);
      serviceBinder.AddMethod(__Method_SetConfigByTargetIDs, serviceImpl.SetConfigByTargetIDs);
    }
