...
class MicrologProxyHubStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SetTaskStatus = channel.unary_unary(
        ...
        response_deserializer=grpcapi__pb2.Void.FromString,
        )
    self.AvailableDSKFStream = channel.unary_stream(
        '/mhubapi.MicrologProxyHub/AvailableDSKFStream',
        request_serializer=grpcapi__pb2.AvailableDSKFStreamInput.SerializeToString,
        response_deserializer=grpcapi__pb2.AvailableDSKFStreamOutput.FromString,
        )
...
def add_MicrologProxyHubServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'SetTaskStatus': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=grpcapi__pb2.Void.SerializeToString,
      ),
      'AvailableDSKFStream': grpc.unary_stream_rpc_method_handler(
          servicer.AvailableDSKFStream,
          request_deserializer=grpcapi__pb2.AvailableDSKFStreamInput.FromString,
          response_serializer=grpcapi__pb2.AvailableDSKFStreamOutput.SerializeToString,
      ),
  }
