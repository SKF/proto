...
_NODE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='childOrderNumber', full_name='grpcapi.Node.childOrderNumber', index=10,
    ...
    _descriptor.FieldDescriptor(
      name='position', full_name='grpcapi.Node.position', index=11,
...
_PRIMITIVEINT64 = _descriptor.Descriptor(
  name='PrimitiveInt64',
  full_name='grpcapi.PrimitiveInt64',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='grpcapi.PrimitiveInt64.value', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NODE.fields_by_name['position'].message_type = _PRIMITIVEINT64
...
DESCRIPTOR.message_types_by_name['PrimitiveInt64'] = _PRIMITIVEINT64
...
PrimitiveInt64 = _reflection.GeneratedProtocolMessageType('PrimitiveInt64', (_message.Message,), dict(
  DESCRIPTOR = _PRIMITIVEINT64,
  __module__ = 'grpcapi_pb2'
  # @@protoc_insertion_point(class_scope:grpcapi.PrimitiveInt64)
  ))
_sym_db.RegisterMessage(PrimitiveInt64)
...
_NODE.fields_by_name['childOrderNumber'].has_options = True
_NODE.fields_by_name['childOrderNumber']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
...
_HIERARCHY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetNodeIdByOrigin',
    full_name='grpcapi.Hierarchy.GetNodeIdByOrigin',
    index=6,
    containing_service=None,
    input_type=_ORIGIN,
    output_type=_PRIMITIVESTRING,
