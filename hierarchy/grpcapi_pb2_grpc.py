...
class HierarchyStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetNodeIdByOrigin = channel.unary_unary(
        '/grpcapi.Hierarchy/GetNodeIdByOrigin',
        request_serializer=grpcapi__pb2.Origin.SerializeToString,
        response_deserializer=grpcapi__pb2.PrimitiveString.FromString,
        )
...
class HierarchyServicer(object):
  ...
  def GetNodeIdByOrigin(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_HierarchyServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetNodeIdByOrigin': grpc.unary_unary_rpc_method_handler(
          servicer.GetNodeIdByOrigin,
          request_deserializer=grpcapi__pb2.Origin.FromString,
          response_serializer=grpcapi__pb2.PrimitiveString.SerializeToString,
      ),
