...
func (Frequency_FrequencyType) EnumDescriptor() ([]byte, []int) {
	return file_pas_grpcapi_proto_rawDescGZIP(), []int{25, 0}
}
...
func (x *SetPointAlarmStatusInput) GetSetBy() string {
	if x != nil {
		return x.SetBy
	}
	return ""
...
func (x *ExternalAlarm) GetSetBy() string {
	if x != nil {
		return x.SetBy
	}
	return ""
...
var file_pas_grpcapi_proto_rawDesc = []byte{
	...
	0x72, 0x6d, 0x73, 0x22, 0xaa, 0x01, 0x0a, 0x18, 0x53, 0x65, 0x74, 0x50, 0x6f, 0x69, 0x6e, 0x74,
	...
	0x6e, 0x52, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x74,
	0x5f, 0x62, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x65, 0x74, 0x42, 0x79,
	0x22, 0x1b, 0x0a, 0x19, 0x53, 0x65, 0x74, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x41, 0x6c, 0x61, 0x72,
	0x6d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x33, 0x0a,
	0x18, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x41, 0x6c, 0x61, 0x72, 0x6d, 0x53, 0x74,
	...
	0x49, 0x64, 0x22, 0x91, 0x01, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x41,
	...
	,
...
var file_pas_grpcapi_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_pas_grpcapi_proto_goTypes = []interface{}{
	...
	(*PointAlarmStatusEvent)(nil),                // 22: pasapi.PointAlarmStatusEvent
	(*GetPointAlarmStatusEventLogInput)(nil),     // 23: pasapi.GetPointAlarmStatusEventLogInput
	(*GetPointAlarmStatusEventLogOutput)(nil),    // 24: pasapi.GetPointAlarmStatusEventLogOutput
	(*CalculateAndSetPointAlarmStatusInput)(nil), // 25: pasapi.CalculateAndSetPointAlarmStatusInput
	(*DoubleObject)(nil),                         // 26: pasapi.DoubleObject
	(*Overall)(nil),                              // 27: pasapi.Overall
	(*Inspection)(nil),                           // 28: pasapi.Inspection
	(*InspectionChoice)(nil),                     // 29: pasapi.InspectionChoice
	(*BandAlarm)(nil),                            // 30: pasapi.BandAlarm
	(*Frequency)(nil),                            // 31: pasapi.Frequency
	(*BandAlarmOverallThreshold)(nil),            // 32: pasapi.BandAlarmOverallThreshold
	(*ThresholdValue)(nil),                       // 33: pasapi.ThresholdValue
	(*common.Origin)(nil),                        // 34: common.Origin
	(*common.Void)(nil),                          // 35: common.Void
}
var file_pas_grpcapi_proto_depIdxs = []int32{
	...
	27, // 10: pasapi.SetPointAlarmThresholdInput.overall:type_name -> pasapi.Overall
	34, // 11: pasapi.SetPointAlarmThresholdInput.origin:type_name -> common.Origin
	28, // 12: pasapi.SetPointAlarmThresholdInput.inspection:type_name -> pasapi.Inspection
	30, // 13: pasapi.SetPointAlarmThresholdInput.band_alarms:type_name -> pasapi.BandAlarm
	26, // 14: pasapi.SetPointAlarmThresholdInput.full_scale:type_name -> pasapi.DoubleObject
	3,  // 15: pasapi.GetPointAlarmThresholdOutput.type:type_name -> pasapi.ThresholdType
	27, // 16: pasapi.GetPointAlarmThresholdOutput.overall:type_name -> pasapi.Overall
	28, // 17: pasapi.GetPointAlarmThresholdOutput.inspection:type_name -> pasapi.Inspection
	26, // 18: pasapi.GetPointAlarmThresholdOutput.full_scale:type_name -> pasapi.DoubleObject
	30, // 19: pasapi.GetPointAlarmThresholdOutput.band_alarms:type_name -> pasapi.BandAlarm
	2,  // 20: pasapi.SetPointAlarmStatusInput.alarm_status:type_name -> pasapi.AlarmStatus
	34, // 21: pasapi.SetPointAlarmStatusInput.origin:type_name -> common.Origin
	2,  // 22: pasapi.GetPointAlarmStatusOutput.alarm_status:type_name -> pasapi.AlarmStatus
	21, // 23: pasapi.GetPointAlarmStatusOutput.external_alarm:type_name -> pasapi.ExternalAlarm
	2,  // 24: pasapi.ExternalAlarm.status:type_name -> pasapi.AlarmStatus
	2,  // 25: pasapi.PointAlarmStatusEvent.status:type_name -> pasapi.AlarmStatus
	22, // 26: pasapi.GetPointAlarmStatusEventLogOutput.events:type_name -> pasapi.PointAlarmStatusEvent
	7,  // 27: pasapi.CalculateAndSetPointAlarmStatusInput.node_data:type_name -> pasapi.NodeData
	26, // 28: pasapi.Overall.outer_high:type_name -> pasapi.DoubleObject
	26, // 29: pasapi.Overall.inner_high:type_name -> pasapi.DoubleObject
	26, // 30: pasapi.Overall.inner_low:type_name -> pasapi.DoubleObject
	26, // 31: pasapi.Overall.outer_low:type_name -> pasapi.DoubleObject
	29, // 32: pasapi.Inspection.choices:type_name -> pasapi.InspectionChoice
	2,  // 33: pasapi.InspectionChoice.status:type_name -> pasapi.AlarmStatus
	31, // 34: pasapi.BandAlarm.min_frequency:type_name -> pasapi.Frequency
	31, // 35: pasapi.BandAlarm.max_frequency:type_name -> pasapi.Frequency
	32, // 36: pasapi.BandAlarm.overall_threshold:type_name -> pasapi.BandAlarmOverallThreshold
	4,  // 37: pasapi.Frequency.value_type:type_name -> pasapi.Frequency.FrequencyType
	26, // 38: pasapi.Frequency.value:type_name -> pasapi.DoubleObject
	33, // 39: pasapi.BandAlarmOverallThreshold.upper_alert:type_name -> pasapi.ThresholdValue
	33, // 40: pasapi.BandAlarmOverallThreshold.upper_danger:type_name -> pasapi.ThresholdValue
	5,  // 41: pasapi.ThresholdValue.value_type:type_name -> pasapi.ThresholdValue.ThresholdValueType
	26, // 42: pasapi.ThresholdValue.value:type_name -> pasapi.DoubleObject
	35, // 43: pasapi.PointAlarmStatus.DeepPing:input_type -> common.Void
	13, // 44: pasapi.PointAlarmStatus.SetPointAlarmThreshold:input_type -> pasapi.SetPointAlarmThresholdInput
	15, // 45: pasapi.PointAlarmStatus.GetPointAlarmThreshold:input_type -> pasapi.GetPointAlarmThresholdInput
	17, // 46: pasapi.PointAlarmStatus.SetPointAlarmStatus:input_type -> pasapi.SetPointAlarmStatusInput
	19, // 47: pasapi.PointAlarmStatus.GetPointAlarmStatus:input_type -> pasapi.GetPointAlarmStatusInput
	23, // 48: pasapi.PointAlarmStatus.GetPointAlarmStatusEventLog:input_type -> pasapi.GetPointAlarmStatusEventLogInput
	25, // 49: pasapi.PointAlarmStatus.CalculateAndSetPointAlarmStatus:input_type -> pasapi.CalculateAndSetPointAlarmStatusInput
	6,  // 50: pasapi.PointAlarmStatus.DeepPing:output_type -> pasapi.DeepPingOutput
	14, // 51: pasapi.PointAlarmStatus.SetPointAlarmThreshold:output_type -> pasapi.SetPointAlarmThresholdOutput
	16, // 52: pasapi.PointAlarmStatus.GetPointAlarmThreshold:output_type -> pasapi.GetPointAlarmThresholdOutput
	18, // 53: pasapi.PointAlarmStatus.SetPointAlarmStatus:output_type -> pasapi.SetPointAlarmStatusOutput
	20, // 54: pasapi.PointAlarmStatus.GetPointAlarmStatus:output_type -> pasapi.GetPointAlarmStatusOutput
	24, // 55: pasapi.PointAlarmStatus.GetPointAlarmStatusEventLog:output_type -> pasapi.GetPointAlarmStatusEventLogOutput
	35, // 56: pasapi.PointAlarmStatus.CalculateAndSetPointAlarmStatus:output_type -> common.Void
